...
CREATE TABLE module_event (
                              ...
                              CONSTRAINT "fk_module_event_organisation_module_service_organisation_module" FOREIGN KEY (organisation_module_service_id) REFERENCES organisation_module_service (id) ON DELETE CASCADE
);
