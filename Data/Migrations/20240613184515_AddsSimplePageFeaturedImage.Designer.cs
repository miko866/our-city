...
namespace Data.Migrations
{
    ...
    [Migration("20240613184515_AddsSimplePageFeaturedImage")]
    partial class AddsSimplePageFeaturedImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.ModuleEvent", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_module_event");

                    b.HasIndex("OrganisationModuleServiceId");

                    b.ToTable("module_event");
                });

            modelBuilder.Entity("Data.Entities.ModuleEventFileItem", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                    ...
                    b.Property<string>("ModuleEventId")
                        .IsRequired()
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                        .HasColumnName("module_event_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_module_event_file_item");

                    b.HasIndex("FileItemId");

                    b.HasIndex("ModuleEventId");

                    b.ToTable("module_event_file_item");
                });

            modelBuilder.Entity("Data.Entities.ModuleEventTag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_module_event_tag");

                    b.HasIndex("ModuleEventId");

                    b.HasIndex("TagId");

                    b.ToTable("module_event_tag");
                });

            modelBuilder.Entity("Data.Entities.ModuleMunicipalRadio", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_module_municipal_radio");

                    b.HasIndex("OrganisationModuleServiceId");

                    b.ToTable("module_municipal_radio");
                });

            modelBuilder.Entity("Data.Entities.ModuleMunicipalRadioMessage", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                    ...
                    b.Property<string>("ModuleMunicipalRadioId")
                        .IsRequired()
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                        .HasColumnName("module_municipal_radio_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_module_municipal_radio_message");

                    b.HasIndex("MessageId");

                    b.HasIndex("ModuleMunicipalRadioId");

                    b.ToTable("module_municipal_radio_message");
                });
            ...
            modelBuilder.Entity("Data.Entities.ModuleSimplePage", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                    ...
                    b.ToTable("module_simple_page");
                });

            modelBuilder.Entity("Data.Entities.ModuleSimplePageFileItem", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                    ...
                    b.Property<string>("ModuleSimplePageId")
                        .IsRequired()
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                        .HasColumnName("module_simple_page_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_module_simple_page_file_item");

                    b.HasIndex("FileItemId");

                    b.HasIndex("ModuleSimplePageId");

                    b.ToTable("module_simple_page_file_item");
                });

            modelBuilder.Entity("Data.Entities.ModuleSpecialAnnouncement", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(8000)
                        .HasColumnType("character varying(8000)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_module_special_announcement");

                    b.HasIndex("OrganisationModuleServiceId");

                    b.ToTable("module_special_announcement");
                });
            ...
            modelBuilder.Entity("Data.Entities.ModuleEvent", b =>
                {
                    b.HasOne("Data.Entities.OrganisationModuleService", "OrganisationModuleService")
                        .WithMany("ModuleEvents")
                        .HasForeignKey("OrganisationModuleServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_event_organisation_module_service_organisation_module_~");
            ...
            modelBuilder.Entity("Data.Entities.ModuleEventFileItem", b =>
                {
                    b.HasOne("Data.Entities.FileItem", "FileItem")
                        .WithMany("ModuleEventFileItems")
                        .HasForeignKey("FileItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_event_file_item_file_item_file_item_id");

                    b.HasOne("Data.Entities.ModuleEvent", "ModuleEvent")
                        .WithMany("ModuleEventFileItems")
                        .HasForeignKey("ModuleEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_event_file_item_module_event_module_event_id");

                    b.Navigation("FileItem");

                    b.Navigation("ModuleEvent");
                });

            modelBuilder.Entity("Data.Entities.ModuleEventTag", b =>
                {
                    b.HasOne("Data.Entities.ModuleEvent", "ModuleEvent")
                        .WithMany("TagModuleEvents")
                        .HasForeignKey("ModuleEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_event_tag_module_event_module_event_id");
                    ...
                    b.HasOne("Data.Entities.Tag", "Tag")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_event_tag_tag_tag_id");
            ...
            modelBuilder.Entity("Data.Entities.ModuleMunicipalRadio", b =>
                {
                    b.HasOne("Data.Entities.OrganisationModuleService", "OrganisationModuleService")
                        .WithMany("ModuleMunicipalRadios")
                        .HasForeignKey("OrganisationModuleServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_municipal_radio_organisation_module_service_organisati~");
            ...
            modelBuilder.Entity("Data.Entities.ModuleMunicipalRadioMessage", b =>
                {
                    b.HasOne("Data.Entities.Message", "Message")
                        .WithMany("ModuleMunicipalRadioMessages")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_municipal_radio_message_message_message_id");

                    b.HasOne("Data.Entities.ModuleMunicipalRadio", "ModuleMunicipalRadio")
                        .WithMany("ModuleMunicipalRadioMessages")
                        .HasForeignKey("ModuleMunicipalRadioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_municipal_radio_message_module_municipal_radio_modul~");

                    b.Navigation("Message");

                    b.Navigation("ModuleMunicipalRadio");
                });
            ...
            modelBuilder.Entity("Data.Entities.ModuleSimplePage", b =>
                {
                    b.HasOne("Data.Entities.OrganisationModuleService", "OrganisationModuleService")
                        .WithMany("ModuleSimplePages")
                        .HasForeignKey("OrganisationModuleServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_simple_page_organisation_module_service_organisation_m~");
            ...
            modelBuilder.Entity("Data.Entities.ModuleSimplePageFileItem", b =>
                {
                    b.HasOne("Data.Entities.FileItem", "FileItem")
                        .WithMany("ModuleSimplePageFileItems")
                        .HasForeignKey("FileItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_simple_page_file_item_file_item_file_item_id");

                    b.HasOne("Data.Entities.ModuleSimplePage", "ModuleSimplePage")
                        .WithMany("ModuleSimplePageFileItems")
                        .HasForeignKey("ModuleSimplePageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_simple_page_file_item_module_simple_page_module_simp~");

                    b.Navigation("FileItem");

                    b.Navigation("ModuleSimplePage");
                });

            modelBuilder.Entity("Data.Entities.ModuleSpecialAnnouncement", b =>
                {
                    b.HasOne("Data.Entities.OrganisationModuleService", "OrganisationModuleService")
                        .WithMany("ModuleSpecialAnnouncements")
                        .HasForeignKey("OrganisationModuleServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_special_announcement_organisation_module_service_organ~");
            ...
            modelBuilder.Entity("Data.Entities.FileItem", b =>
                {
                    b.Navigation("ModuleEventFileItems");

                    b.Navigation("ModuleNewsFileItems");

                    b.Navigation("ModuleSimplePageFileItems");
            ...
            modelBuilder.Entity("Data.Entities.Message", b =>
                {
                    b.Navigation("ModuleMunicipalRadioMessages");
                });
            ...
            modelBuilder.Entity("Data.Entities.OrganisationModuleService", b =>
                {
                    b.Navigation("ModuleEvents");

                    b.Navigation("ModuleMunicipalRadios");

                    b.Navigation("ModuleNews");

                    b.Navigation("ModuleSimplePages");

                    b.Navigation("ModuleSpecialAnnouncements");
                });
